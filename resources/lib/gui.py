...
class GUI(xbmcgui.WindowXMLDialog):
    ...
    def dashboardCallback(self, index, size, artist, album_title=None):
        ...
        return self.getControl(CONTROLID_ACTION_START).getLabel() == utils.lang(20186, False)  # Cancelled
